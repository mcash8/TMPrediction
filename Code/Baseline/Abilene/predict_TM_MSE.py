...
def main():
    ...
    min_max_norm = True
    feature_norm = False
    percent = 0.1 # specified as decimal
    ...
    # Save the model 
    PATH = 'models\\abilene_global_mse.pth'
    torch.save(model.state_dict(), PATH)

    # Save the model_outputs
    np.save('model_outputs\\abilene_global_mse.npy', 
            model_outputs)
    ...
    # Save MLUs
    np.save('model_outputs\\mlu_preds_abilene_global_mse.npy', mlu_preds)
    ...
    plot_and_save_ecdf(mlu_gt, mlu_preds, save_path = 'Figs\\ecdfs', fig_name='CDF_mlu_abilene_global_mse.png')
    plot_and_save_mlu_compare(mlu_gt, mlu_preds, save_path='Figs\\mlu_compare', fig_name='mlu_compare_abilene_global_mse.png')
    plot_and_save_pdf(mlu_gt, mlu_preds, save_path = 'Figs\\pdfs', fig_name='PDF_mlu_abilene_global_mse.png')
