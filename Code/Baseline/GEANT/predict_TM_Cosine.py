...
def main():
    ...
    # Save the model 
    PATH = 'models\\geant_global_cosine.pth'
    torch.save(model.state_dict(), PATH)

    # Save the model_outputs
    np.save('model_outputs\\geant_global_cosine.npy', 
            model_outputs)
    ...
    # Save MLUs
    np.save('mlu_baseline\\mlu_preds_geant_global_cosine.npy', mlu_preds)
    ...
    plot_and_save_ecdf(mlu_gt, mlu_preds, save_path = 'Figs\\ecdfs', fig_name='CDF_mlu_geant_global_cosine.png')
    plot_and_save_mlu_compare(mlu_gt, mlu_preds, save_path='Figs\\mlu_compare', fig_name='mlu_compare_geant_global_cosine.png')
    plot_and_save_pdf(mlu_gt, mlu_preds, save_path = 'Figs\\pdfs', fig_name='PDF_mlu_geant_global_cosine.png')
